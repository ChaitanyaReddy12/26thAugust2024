...
public class BaseOrCommon {
	...
	public void screenshot(String screenshotName) throws IOException {
		...
		File narmada = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);

		FileUtils.copyFile(narmada, new File(
				"C:\\Users\\Abcom\\eclipse-workspace\\26thAugust2024\\Automation\\src\\test\\java\\Screenshots\\"
						+ screenshotName + ".png"));
	}
