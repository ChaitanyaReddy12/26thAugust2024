...
public class Attribute_Description extends BaseOrCommon{
	...
	@Test (priority = 1, timeOut = 7000, description = "this method is used to enter username in the login page" )//7 seconds
	...
	@Test(priority = 3,description = "this method is used to click Login button in the login page")
